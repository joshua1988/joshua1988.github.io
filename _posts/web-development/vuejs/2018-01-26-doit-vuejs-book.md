...
## Do it! Vue.js 입문 서적을 집필하면서..
Do it! Vue.js 입문서를 잠깐 소개하겠습니다.
...
감이 잘 안 왔었거든요. 그때 다행히 기술서 편집 경험이 많은 훌륭한 편집자님을 만나 요약된 정보 위주로 전달하는 블로그 글 형식에서 더 친절하고 쉽고 자세히
...
1차로 제가 작업한 내용을 개발 지식이 있는 전문 디자이너 분께 2차 작업을 맡겼고, 3차로 다시 디자이너 분과 논의하면서 도형을 다듬었습니다.
