...
excerpt: "API 데이터 요청을 위해 꼭 알아야 하는 HTTP 프로토콜의 정의, 구조, 상태 코드, 요청 메서드 등"
image:
  teaser: posts/web/http/http-full-structure.png
  credit: Captain Pangyo #name of the person or site you want to credit
