...
이 책은 서점에 타입스크립트 입문서라고 소개되어 있습니다. 입문서이기 때문에 당연히 타입스크립트를 처음 배우시는 분들이 보기 좋은 책이라고 생각하실 것 같아요. 저도 당연히 타입스크립트를 배우기 전 시점으로 돌아간다면 이 책으로 타입스크립트를 배우고 싶을 것 같아요. 제가 오랜 기간 동안 쓴 책이라서 그런 게 아니라 **제가 여태까지 개발자로서 경험한 모든 타입스크립트의 내용을 집약하고 압축했기 때문입니다.** 과거에 지식을 얻기 위해 보낸 시간들을 훨씬 더 줄여줄 수 있는 책이라고 생각합니다.
...
입문서라서 입문자만 읽어야 하는 책은 아닙니다. 이 책의 편집 과정에서 기술 검수를 네이버 15년 차 FE 개발자와 토스 8년 차 FE 개발자 두 분께 부탁드렸습니다. 그분들도 보시면서 새롭게 배운 내용들이 있었다고 하시더라구요. 여기까지 봤을 때 다음 3가지 특징 덕택에 입문자와 이미 타입스크립트를 쓰고는 있는데 제대로 쓰고 싶은 실무자 분들이 보시면 좋을 것 같네요.

- 과거 5년 간의 모든 타입스크립트 지식을 압축한 결과물
- 쉽고 재밌게 배울 수 있는 설명과 300개의 그림
- 실무 개발자도 배워갈게 많은 동작 원리와 고급 개념
